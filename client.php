	      		...
	      		<div class="div-result">
				 			...
				 			<form class="form-horizontal" id="editClientForm" action="php_action/editClient.php" method="POST">
								...
								<div class="form-group">
						        	<label for="editClientID" class="col-sm-3 control-label">Cedula: </label>
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitClientForm" action="php_action/createClient.php" method="POST" enctype="multipart/form-data">
			    ...
			    <div class="modal-body" style="max-height:450px; overflow:auto;">
                    ...
                    <div class="form-group">
                        <label for="clientCed" class="col-sm-3 control-label">Cedula: </label>
                        <label class="col-sm-1 control-label">: </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="clientCed" name="clientCed" placeholder="Cedula del cliente" autocomplete="off">
                        </div>
                    </div> <!-- /form-group-->
