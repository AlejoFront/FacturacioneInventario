...
$data = "SELECT orders.id_order, orders.fecha_add, orders.hora_add, orders.client_id, 
                orders.total_neto, orders.descuento, orders.total, orders.metodo, orders.totalProducto, 
                orders.tipo_orden, orders.monto, orders.saldo, orders.estado, orders.fecha_liqui, 
                orders.user_add_id, clients.id_client, clients.nombre_cte, clients.categoria, clients.comentario 
		 FROM orders 
		 INNER JOIN clients 
