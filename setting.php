...
$query = "SELECT id_client, nombre, status FROM clients WHERE  status = 2";
			...
			<form class="form-horizontal" id="submitUsertForm" action="php_action/createUser.php" method="POST" enctype="multipart/form-data">
			    ...
			    <div class="modal-body" style="max-height:450px; overflow:auto;">
	        		...
	        		<div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="password" class="form-control" id="UserPass" placeholder="Contraseña" name="UserPass" autocomplete="off">
						    </div>
	        		</div> <!-- /form-group-->   
