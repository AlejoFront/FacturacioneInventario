...
$(document).ready(function() {
	...
	$("#addClientModalBtn").unbind('click').bind('click', function() {
		...
		$(".form-group").removeClass('has-error').removeClass('has-success');
			...
			if (ClientCed == ""){
				$("#clientCed").after('<p class="text-danger">Este campo es obligatorio</p>');
				$("#clientCed").closest('.form-group').addClass('has-error');
			}	else {
				$("#clientCed").find('.text-danger').remove();
				// success out for form
				$("#clientCed").closest('.form-group').addClass('has-success');
			}
